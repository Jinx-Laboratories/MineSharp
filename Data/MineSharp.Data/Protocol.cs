...
namespace MineSharp.Data.Protocol
{
	...
	public class ParticleDataSwitch
	{
		...
		public class ParticleDataSwitchState25
		{
			public VarInt BlockState { get; set; }
			public ParticleDataSwitchState25(VarInt @blockState)
			{
				this.BlockState = @blockState;
			}
			public void Write(PacketBuffer buffer )
			...
			public static ParticleDataSwitchState25 Read(PacketBuffer buffer )
			{
				VarInt @blockState = ((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer);
				return new ParticleDataSwitchState25(@blockState);
			}
		}
		public class ParticleDataSwitchState39
		{
			public Slot Item { get; set; }
			public ParticleDataSwitchState39(Slot @item)
			{
				this.Item = @item;
			}
			public void Write(PacketBuffer buffer )
			...
			public static ParticleDataSwitchState39 Read(PacketBuffer buffer )
			{
				Slot @item = ((Func<PacketBuffer, Slot>)((buffer) => MineSharp.Data.Protocol.Slot.Read(buffer )))(buffer);
				return new ParticleDataSwitchState39(@item);
			}
		}
		public class ParticleDataSwitchState40
		{
			public class EntityIdSwitch
			{
				...
				public static EntityIdSwitch Read(PacketBuffer buffer, string state)
				{
					object? value = state switch
					{
			...
			public class EntityEyeHeightSwitch
			{
				public object? Value { get; set; }
				public EntityEyeHeightSwitch(object? value)
				{
					this.Value = value;
				}
				public void Write(PacketBuffer buffer, string state)
				...
				public static EntityEyeHeightSwitch Read(PacketBuffer buffer, string state)
				{
					object? value = state switch
					{
						"minecraft:entity" => ((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer),
					...
					return new EntityEyeHeightSwitch(value);
				}
				public static implicit operator VarInt?(EntityEyeHeightSwitch value) => (VarInt?)value.Value;
				public static implicit operator EntityEyeHeightSwitch?(VarInt? value) => new EntityEyeHeightSwitch(value);
			}
			...
			public EntityEyeHeightSwitch EntityEyeHeight { get; set; }
			public DestinationSwitch Destination { get; set; }
			public VarInt Ticks { get; set; }
			public ParticleDataSwitchState40(string @positionType, PositionBitfield @origin, EntityIdSwitch @entityId, EntityEyeHeightSwitch @entityEyeHeight, DestinationSwitch @destination, VarInt @ticks)
			{
			...
			public void Write(PacketBuffer buffer )
			{
				...
				((Action<PacketBuffer, EntityIdSwitch>)((buffer, value) => value.Write(buffer, PositionType)))(buffer, this.EntityId);
				((Action<PacketBuffer, EntityEyeHeightSwitch>)((buffer, value) => value.Write(buffer, PositionType)))(buffer, this.EntityEyeHeight);
			...
			public static ParticleDataSwitchState40 Read(PacketBuffer buffer )
			{
				...
				EntityIdSwitch @entityId = ((Func<PacketBuffer, EntityIdSwitch>)((buffer) => EntityIdSwitch.Read(buffer, @positionType)))(buffer);
				EntityEyeHeightSwitch @entityEyeHeight = ((Func<PacketBuffer, EntityEyeHeightSwitch>)((buffer) => EntityEyeHeightSwitch.Read(buffer, @positionType)))(buffer);
				...
				return new ParticleDataSwitchState40(@positionType, @origin, @entityId, @entityEyeHeight, @destination, @ticks);
			}
		}
		public class ParticleDataSwitchState92
		{
			public VarInt DelayInTicksBeforeShown { get; set; }
			public ParticleDataSwitchState92(VarInt @delayInTicksBeforeShown)
			{
				this.DelayInTicksBeforeShown = @delayInTicksBeforeShown;
			}
			public void Write(PacketBuffer buffer )
			{
				((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))(buffer, this.DelayInTicksBeforeShown);
			}
			public static ParticleDataSwitchState92 Read(PacketBuffer buffer )
			{
				VarInt @delayInTicksBeforeShown = ((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer);
				return new ParticleDataSwitchState92(@delayInTicksBeforeShown);
			}
		}
		public object? Value { get; set; }
		...
		public void Write(PacketBuffer buffer, int state)
		{
			switch (state)
			{
				...
				case 25: ((Action<PacketBuffer, ParticleDataSwitchState25>)((buffer, value) => value.Write(buffer )))(buffer, (ParticleDataSwitchState25)this); break;
				case 39: ((Action<PacketBuffer, ParticleDataSwitchState39>)((buffer, value) => value.Write(buffer )))(buffer, (ParticleDataSwitchState39)this); break;
				case 40: ((Action<PacketBuffer, ParticleDataSwitchState40>)((buffer, value) => value.Write(buffer )))(buffer, (ParticleDataSwitchState40)this); break;
				case 92: ((Action<PacketBuffer, ParticleDataSwitchState92>)((buffer, value) => value.Write(buffer )))(buffer, (ParticleDataSwitchState92)this); break;
				default: ((Action<PacketBuffer, object?>)((buffer, value) => buffer.WriteVoid(value)))(buffer, (object?)Value); break;
			}
		}
		public static ParticleDataSwitch Read(PacketBuffer buffer, int state)
		{
			object? value = state switch
			{
				...
				25 => ((Func<PacketBuffer, ParticleDataSwitchState25>)((buffer) => MineSharp.Data.Protocol.ParticleDataSwitch.ParticleDataSwitchState25.Read(buffer )))(buffer),
				39 => ((Func<PacketBuffer, ParticleDataSwitchState39>)((buffer) => MineSharp.Data.Protocol.ParticleDataSwitch.ParticleDataSwitchState39.Read(buffer )))(buffer),
				40 => ((Func<PacketBuffer, ParticleDataSwitchState40>)((buffer) => MineSharp.Data.Protocol.ParticleDataSwitch.ParticleDataSwitchState40.Read(buffer )))(buffer),
				92 => ((Func<PacketBuffer, ParticleDataSwitchState92>)((buffer) => MineSharp.Data.Protocol.ParticleDataSwitch.ParticleDataSwitchState92.Read(buffer )))(buffer),
				_ => ((Func<PacketBuffer, object?>)((buffer) => buffer.ReadVoid()))(buffer)
			};
		...
		public static implicit operator ParticleDataSwitchState25?(ParticleDataSwitch value) => (ParticleDataSwitchState25?)value.Value;
		public static implicit operator ParticleDataSwitchState39?(ParticleDataSwitch value) => (ParticleDataSwitchState39?)value.Value;
		public static implicit operator ParticleDataSwitchState40?(ParticleDataSwitch value) => (ParticleDataSwitchState40?)value.Value;
		public static implicit operator ParticleDataSwitchState92?(ParticleDataSwitch value) => (ParticleDataSwitchState92?)value.Value;
		...
		public static implicit operator ParticleDataSwitch?(ParticleDataSwitchState25? value) => new ParticleDataSwitch(value);
		public static implicit operator ParticleDataSwitch?(ParticleDataSwitchState39? value) => new ParticleDataSwitch(value);
		public static implicit operator ParticleDataSwitch?(ParticleDataSwitchState40? value) => new ParticleDataSwitch(value);
		public static implicit operator ParticleDataSwitch?(ParticleDataSwitchState92? value) => new ParticleDataSwitch(value);
	}
	...
	public class PreviousMessagesElement
	{
		...
		public void Write(PacketBuffer buffer )
		{
			((Action<PacketBuffer, UUID>)((buffer, value) => buffer.WriteUUID(value)))(buffer, this.MessageSender);
...
namespace MineSharp.Data.Protocol.Play.Serverbound
{
	...
	public class PacketChatCommand : IPacketPayload
	{
		public class ArgumentSignaturesElementContainer
		{
			...
			public void Write(PacketBuffer buffer )
			{
				((Action<PacketBuffer, string>)((buffer, value) => buffer.WritePString(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.ArgumentName);
		...
		public class LastRejectedMessageContainer
		{
			public UUID Sender { get; set; }
			public byte[] Signature { get; set; }
			public LastRejectedMessageContainer(UUID @sender, byte[] @signature)
			{
				this.Sender = @sender;
				this.Signature = @signature;
			}
			...
			public static LastRejectedMessageContainer Read(PacketBuffer buffer )
			{
				UUID @sender = ((Func<PacketBuffer, UUID>)((buffer) => buffer.ReadUUID()))(buffer);
				byte[] @signature = ((Func<PacketBuffer, byte[]>)((buffer) => buffer.ReadBuffer(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer))))(buffer);
				return new LastRejectedMessageContainer(@sender, @signature);
			}
		}
		...
		public LastRejectedMessageContainer? LastRejectedMessage { get; set; }
		public PacketChatCommand(string @command, long @timestamp, long @salt, ArgumentSignaturesElementContainer[] @argumentSignatures, bool @signedPreview, PreviousMessagesElement[] @previousMessages, LastRejectedMessageContainer? @lastRejectedMessage)
		{
		...
		public void Write(PacketBuffer buffer )
		{
			...
			((Action<PacketBuffer, ArgumentSignaturesElementContainer[]>)((buffer, value) => buffer.WriteArray(value, ((Action<PacketBuffer, ArgumentSignaturesElementContainer>)((buffer, value) => value.Write(buffer ))), ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.ArgumentSignatures);
			((Action<PacketBuffer, bool>)((buffer, value) => buffer.WriteBool(value)))(buffer, this.SignedPreview);
			...
			((Action<PacketBuffer, LastRejectedMessageContainer?>)((buffer, value) => buffer.WriteOption(value, ((Action<PacketBuffer, LastRejectedMessageContainer>)((buffer, value) => value.Write(buffer ))))))(buffer, this.LastRejectedMessage);
		}
		public static PacketChatCommand Read(PacketBuffer buffer )
		{
			...
			ArgumentSignaturesElementContainer[] @argumentSignatures = ((Func<PacketBuffer, ArgumentSignaturesElementContainer[]>)((buffer) => buffer.ReadArray(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer), ((Func<PacketBuffer, ArgumentSignaturesElementContainer>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketChatCommand.ArgumentSignaturesElementContainer.Read(buffer ))))))(buffer);
			bool @signedPreview = ((Func<PacketBuffer, bool>)((buffer) => buffer.ReadBool()))(buffer);
			PreviousMessagesElement[] @previousMessages = ((Func<PacketBuffer, PreviousMessagesElement[]>)((buffer) => buffer.ReadArray(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer), ((Func<PacketBuffer, PreviousMessagesElement>)((buffer) => MineSharp.Data.Protocol.PreviousMessagesElement.Read(buffer ))))))(buffer);
			LastRejectedMessageContainer? @lastRejectedMessage = ((Func<PacketBuffer, LastRejectedMessageContainer?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, LastRejectedMessageContainer>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketChatCommand.LastRejectedMessageContainer.Read(buffer ))))))(buffer);
			return new PacketChatCommand(@command, @timestamp, @salt, @argumentSignatures, @signedPreview, @previousMessages, @lastRejectedMessage);
		}
	}
	public class PacketChatMessage : IPacketPayload
	{
		...
		public PreviousMessagesElement[] PreviousMessages { get; set; }
		public LastRejectedMessageContainer? LastRejectedMessage { get; set; }
		public PacketChatMessage(string @message, long @timestamp, long @salt, byte[] @signature, bool @signedPreview, PreviousMessagesElement[] @previousMessages, LastRejectedMessageContainer? @lastRejectedMessage)
		{
		...
		public static PacketChatMessage Read(PacketBuffer buffer )
		{
			...
			bool @signedPreview = ((Func<PacketBuffer, bool>)((buffer) => buffer.ReadBool()))(buffer);
			PreviousMessagesElement[] @previousMessages = ((Func<PacketBuffer, PreviousMessagesElement[]>)((buffer) => buffer.ReadArray(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer), ((Func<PacketBuffer, PreviousMessagesElement>)((buffer) => MineSharp.Data.Protocol.PreviousMessagesElement.Read(buffer ))))))(buffer);
			LastRejectedMessageContainer? @lastRejectedMessage = ((Func<PacketBuffer, LastRejectedMessageContainer?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, LastRejectedMessageContainer>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketChatMessage.LastRejectedMessageContainer.Read(buffer ))))))(buffer);
			return new PacketChatMessage(@message, @timestamp, @salt, @signature, @signedPreview, @previousMessages, @lastRejectedMessage);
		}
	}
	public class PacketChatPreview : IPacketPayload
	{
		...
		public void Write(PacketBuffer buffer )
		{
			((Action<PacketBuffer, int>)((buffer, value) => buffer.WriteI32(value)))(buffer, this.Query);
			((Action<PacketBuffer, string>)((buffer, value) => buffer.WritePString(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.Message);
		}
	...
	public class PacketMessageAcknowledgement : IPacketPayload
	{
		...
		public PreviousMessagesElement[] PreviousMessages { get; set; }
		public LastRejectedMessageContainer? LastRejectedMessage { get; set; }
		public PacketMessageAcknowledgement(PreviousMessagesElement[] @previousMessages, LastRejectedMessageContainer? @lastRejectedMessage)
		{
			this.PreviousMessages = @previousMessages;
			this.LastRejectedMessage = @lastRejectedMessage;
		}
		...
		{
			PreviousMessagesElement[] @previousMessages = ((Func<PacketBuffer, PreviousMessagesElement[]>)((buffer) => buffer.ReadArray(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer), ((Func<PacketBuffer, PreviousMessagesElement>)((buffer) => MineSharp.Data.Protocol.PreviousMessagesElement.Read(buffer ))))))(buffer);
			LastRejectedMessageContainer? @lastRejectedMessage = ((Func<PacketBuffer, LastRejectedMessageContainer?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, LastRejectedMessageContainer>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketMessageAcknowledgement.LastRejectedMessageContainer.Read(buffer ))))))(buffer);
			return new PacketMessageAcknowledgement(@previousMessages, @lastRejectedMessage);
		}
	}
	...
	public class PacketSetBeaconEffect : IPacketPayload
	{
		...
		public void Write(PacketBuffer buffer )
		{
			((Action<PacketBuffer, VarInt?>)((buffer, value) => buffer.WriteOption(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.PrimaryEffect);
			((Action<PacketBuffer, VarInt?>)((buffer, value) => buffer.WriteOption(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.SecondaryEffect);
		}
	...
	public class PacketBlockDig : IPacketPayload
	{
		...
		public void Write(PacketBuffer buffer )
		{
			...
			((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))(buffer, this.Sequence);
		}
		...
		public class ParamsSwitch
		{
			...
			public static ParamsSwitch Read(PacketBuffer buffer, string state)
			{
				object? value = state switch
				{
					...
					"message_acknowledgement" => ((Func<PacketBuffer, PacketMessageAcknowledgement>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketMessageAcknowledgement.Read(buffer )))(buffer),
					"chat_command" => ((Func<PacketBuffer, PacketChatCommand>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketChatCommand.Read(buffer )))(buffer),
					"chat_message" => ((Func<PacketBuffer, PacketChatMessage>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketChatMessage.Read(buffer )))(buffer),
					"chat_preview" => ((Func<PacketBuffer, PacketChatPreview>)((buffer) => MineSharp.Data.Protocol.Play.Serverbound.PacketChatPreview.Read(buffer )))(buffer),
	...
	public class PlayPacketFactory : IPacketFactory 
	{
	    ...
	    public static void WritePacket(PacketBuffer buffer, IPacketPayload packet) 
	    {
	        switch (packet)
	        {
	                ...
	                case PacketMessageAcknowledgement p_0x03: new MineSharp.Data.Protocol.Play.Serverbound.Packet("message_acknowledgement", p_0x03!).Write(buffer); break;
	                case PacketChatCommand p_0x04: new MineSharp.Data.Protocol.Play.Serverbound.Packet("chat_command", p_0x04!).Write(buffer); break;
	                case PacketChatMessage p_0x05: new MineSharp.Data.Protocol.Play.Serverbound.Packet("chat_message", p_0x05!).Write(buffer); break;
	                case PacketChatPreview p_0x06: new MineSharp.Data.Protocol.Play.Serverbound.Packet("chat_preview", p_0x06!).Write(buffer); break;
	                case PacketClientCommand p_0x07: new MineSharp.Data.Protocol.Play.Serverbound.Packet("client_command", p_0x07!).Write(buffer); break;
	                case PacketSettings p_0x08: new MineSharp.Data.Protocol.Play.Serverbound.Packet("settings", p_0x08!).Write(buffer); break;
	                case PacketTabComplete p_0x09: new MineSharp.Data.Protocol.Play.Serverbound.Packet("tab_complete", p_0x09!).Write(buffer); break;
	                case PacketEnchantItem p_0x0A: new MineSharp.Data.Protocol.Play.Serverbound.Packet("enchant_item", p_0x0A!).Write(buffer); break;
	                case PacketWindowClick p_0x0B: new MineSharp.Data.Protocol.Play.Serverbound.Packet("window_click", p_0x0B!).Write(buffer); break;
	                case PacketCloseWindow p_0x0C: new MineSharp.Data.Protocol.Play.Serverbound.Packet("close_window", p_0x0C!).Write(buffer); break;
	                case PacketCustomPayload p_0x0D: new MineSharp.Data.Protocol.Play.Serverbound.Packet("custom_payload", p_0x0D!).Write(buffer); break;
	                case PacketEditBook p_0x0E: new MineSharp.Data.Protocol.Play.Serverbound.Packet("edit_book", p_0x0E!).Write(buffer); break;
	                case PacketQueryEntityNbt p_0x0F: new MineSharp.Data.Protocol.Play.Serverbound.Packet("query_entity_nbt", p_0x0F!).Write(buffer); break;
	                case PacketUseEntity p_0x10: new MineSharp.Data.Protocol.Play.Serverbound.Packet("use_entity", p_0x10!).Write(buffer); break;
	                case PacketGenerateStructure p_0x11: new MineSharp.Data.Protocol.Play.Serverbound.Packet("generate_structure", p_0x11!).Write(buffer); break;
	                case PacketKeepAlive p_0x12: new MineSharp.Data.Protocol.Play.Serverbound.Packet("keep_alive", p_0x12!).Write(buffer); break;
	                case PacketLockDifficulty p_0x13: new MineSharp.Data.Protocol.Play.Serverbound.Packet("lock_difficulty", p_0x13!).Write(buffer); break;
	                case PacketPosition p_0x14: new MineSharp.Data.Protocol.Play.Serverbound.Packet("position", p_0x14!).Write(buffer); break;
	                case PacketPositionLook p_0x15: new MineSharp.Data.Protocol.Play.Serverbound.Packet("position_look", p_0x15!).Write(buffer); break;
	                case PacketLook p_0x16: new MineSharp.Data.Protocol.Play.Serverbound.Packet("look", p_0x16!).Write(buffer); break;
	                case PacketFlying p_0x17: new MineSharp.Data.Protocol.Play.Serverbound.Packet("flying", p_0x17!).Write(buffer); break;
	                case PacketVehicleMove p_0x18: new MineSharp.Data.Protocol.Play.Serverbound.Packet("vehicle_move", p_0x18!).Write(buffer); break;
	                case PacketSteerBoat p_0x19: new MineSharp.Data.Protocol.Play.Serverbound.Packet("steer_boat", p_0x19!).Write(buffer); break;
	                case PacketPickItem p_0x1A: new MineSharp.Data.Protocol.Play.Serverbound.Packet("pick_item", p_0x1A!).Write(buffer); break;
	                case PacketCraftRecipeRequest p_0x1B: new MineSharp.Data.Protocol.Play.Serverbound.Packet("craft_recipe_request", p_0x1B!).Write(buffer); break;
	                case PacketAbilities p_0x1C: new MineSharp.Data.Protocol.Play.Serverbound.Packet("abilities", p_0x1C!).Write(buffer); break;
	                case PacketBlockDig p_0x1D: new MineSharp.Data.Protocol.Play.Serverbound.Packet("block_dig", p_0x1D!).Write(buffer); break;
	                case PacketEntityAction p_0x1E: new MineSharp.Data.Protocol.Play.Serverbound.Packet("entity_action", p_0x1E!).Write(buffer); break;
	                case PacketSteerVehicle p_0x1F: new MineSharp.Data.Protocol.Play.Serverbound.Packet("steer_vehicle", p_0x1F!).Write(buffer); break;
	                case PacketPong p_0x20: new MineSharp.Data.Protocol.Play.Serverbound.Packet("pong", p_0x20!).Write(buffer); break;
	                case PacketRecipeBook p_0x21: new MineSharp.Data.Protocol.Play.Serverbound.Packet("recipe_book", p_0x21!).Write(buffer); break;
	                case PacketDisplayedRecipe p_0x22: new MineSharp.Data.Protocol.Play.Serverbound.Packet("displayed_recipe", p_0x22!).Write(buffer); break;
	                case PacketNameItem p_0x23: new MineSharp.Data.Protocol.Play.Serverbound.Packet("name_item", p_0x23!).Write(buffer); break;
	                case PacketResourcePackReceive p_0x24: new MineSharp.Data.Protocol.Play.Serverbound.Packet("resource_pack_receive", p_0x24!).Write(buffer); break;
	                case PacketAdvancementTab p_0x25: new MineSharp.Data.Protocol.Play.Serverbound.Packet("advancement_tab", p_0x25!).Write(buffer); break;
	                case PacketSelectTrade p_0x26: new MineSharp.Data.Protocol.Play.Serverbound.Packet("select_trade", p_0x26!).Write(buffer); break;
	                case PacketSetBeaconEffect p_0x27: new MineSharp.Data.Protocol.Play.Serverbound.Packet("set_beacon_effect", p_0x27!).Write(buffer); break;
	                case PacketHeldItemSlot p_0x28: new MineSharp.Data.Protocol.Play.Serverbound.Packet("held_item_slot", p_0x28!).Write(buffer); break;
	                case PacketUpdateCommandBlock p_0x29: new MineSharp.Data.Protocol.Play.Serverbound.Packet("update_command_block", p_0x29!).Write(buffer); break;
	                case PacketUpdateCommandBlockMinecart p_0x2A: new MineSharp.Data.Protocol.Play.Serverbound.Packet("update_command_block_minecart", p_0x2A!).Write(buffer); break;
	                case PacketSetCreativeSlot p_0x2B: new MineSharp.Data.Protocol.Play.Serverbound.Packet("set_creative_slot", p_0x2B!).Write(buffer); break;
	                case PacketUpdateJigsawBlock p_0x2C: new MineSharp.Data.Protocol.Play.Serverbound.Packet("update_jigsaw_block", p_0x2C!).Write(buffer); break;
	                case PacketUpdateStructureBlock p_0x2D: new MineSharp.Data.Protocol.Play.Serverbound.Packet("update_structure_block", p_0x2D!).Write(buffer); break;
	                case PacketUpdateSign p_0x2E: new MineSharp.Data.Protocol.Play.Serverbound.Packet("update_sign", p_0x2E!).Write(buffer); break;
	                case PacketArmAnimation p_0x2F: new MineSharp.Data.Protocol.Play.Serverbound.Packet("arm_animation", p_0x2F!).Write(buffer); break;
	                case PacketSpectate p_0x30: new MineSharp.Data.Protocol.Play.Serverbound.Packet("spectate", p_0x30!).Write(buffer); break;
	                case PacketBlockPlace p_0x31: new MineSharp.Data.Protocol.Play.Serverbound.Packet("block_place", p_0x31!).Write(buffer); break;
	                case PacketUseItem p_0x32: new MineSharp.Data.Protocol.Play.Serverbound.Packet("use_item", p_0x32!).Write(buffer); break;
...
namespace MineSharp.Data.Protocol.Play.Clientbound
{
	public class PacketSpawnEntity : IPacketPayload
	{
		...
		public void Write(PacketBuffer buffer )
		{
			...
			((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))(buffer, this.ObjectData);
	...
	public class PacketChatPreview : IPacketPayload
	{
		...
		public void Write(PacketBuffer buffer )
		{
			((Action<PacketBuffer, int>)((buffer, value) => buffer.WriteI32(value)))(buffer, this.QueryId);
			((Action<PacketBuffer, string?>)((buffer, value) => buffer.WriteOption(value, ((Action<PacketBuffer, string>)((buffer, value) => buffer.WritePString(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))))))))(buffer, this.Message);
		}
		public static PacketChatPreview Read(PacketBuffer buffer )
		{
	...
	public class PacketMultiBlockChange : IPacketPayload
	{
		...
		public void Write(PacketBuffer buffer )
		{
			...
			((Action<PacketBuffer, bool>)((buffer, value) => buffer.WriteBool(value)))(buffer, this.SuppressLightUpdates);
	...
	public class PacketChatSuggestions : IPacketPayload
	{
		...
		{
			((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))(buffer, this.Action);
			((Action<PacketBuffer, string[]>)((buffer, value) => buffer.WriteArray(value, ((Action<PacketBuffer, string>)((buffer, value) => buffer.WritePString(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))))), ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.Entries);
		}
	...
	public class PacketLogin : IPacketPayload
	{
		...
		public static PacketLogin Read(PacketBuffer buffer )
		{
			...
			DeathContainer? @death = ((Func<PacketBuffer, DeathContainer?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, DeathContainer>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketLogin.DeathContainer.Read(buffer ))))))(buffer);
	...
	public class PacketTradeList : IPacketPayload
	{
		public class TradesElementContainer
		{
			...
			public static TradesElementContainer Read(PacketBuffer buffer )
			{
				...
				Slot @inputItem2 = ((Func<PacketBuffer, Slot>)((buffer) => MineSharp.Data.Protocol.Slot.Read(buffer )))(buffer);
		...
		{
			VarInt @windowId = ((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer);
			TradesElementContainer[] @trades = ((Func<PacketBuffer, TradesElementContainer[]>)((buffer) => buffer.ReadArray(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer), ((Func<PacketBuffer, TradesElementContainer>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketTradeList.TradesElementContainer.Read(buffer ))))))(buffer);
	...
	public class PacketPlayerChat : IPacketPayload
	{
		...
		public PacketPlayerChat(byte[]? @previousSignature, UUID @senderUuid, byte[] @signature, string @plainMessage, string? @formattedMessage, long @timestamp, long @salt, PreviousMessagesElement[] @previousMessages, string? @unsignedContent, VarInt @filterType, FilterTypeMaskSwitch @filterTypeMask, VarInt @type, string @networkName, string? @networkTargetName)
		{
		...
		public void Write(PacketBuffer buffer )
		{
			((Action<PacketBuffer, byte[]?>)((buffer, value) => buffer.WriteOption(value, ((Action<PacketBuffer, byte[]>)((buffer, value) => buffer.WriteBuffer(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value)))))))))(buffer, this.PreviousSignature);
		...
		{
			byte[]? @previousSignature = ((Func<PacketBuffer, byte[]?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, byte[]>)((buffer) => buffer.ReadBuffer(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer)))))))(buffer);
			...
			return new PacketPlayerChat(@previousSignature, @senderUuid, @signature, @plainMessage, @formattedMessage, @timestamp, @salt, @previousMessages, @unsignedContent, @filterType, @filterTypeMask, @type, @networkName, @networkTargetName);
		}
	}
		...
		public class DataElementContainer
		{
			...
			public class CryptoSwitch
			{
				...
				public static CryptoSwitch Read(PacketBuffer buffer, VarInt state, VarInt @action)
				{
					object? value = state.Value switch
					{
						0 => ((Func<PacketBuffer, CryptoSwitchState0Container?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, CryptoSwitchState0Container>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketPlayerInfo.DataElementContainer.CryptoSwitch.CryptoSwitchState0Container.Read(buffer ))))))(buffer),
						_ => ((Func<PacketBuffer, object?>)((buffer) => buffer.ReadVoid()))(buffer)
					};
	...
	public class PacketRespawn : IPacketPayload
	{
		...
		public static PacketRespawn Read(PacketBuffer buffer )
		{
			...
			DeathContainer? @death = ((Func<PacketBuffer, DeathContainer?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, DeathContainer>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketRespawn.DeathContainer.Read(buffer ))))))(buffer);
	...
	public class PacketEntitySoundEffect : IPacketPayload
	{
		...
		public float Pitch { get; set; }
		public long Seed { get; set; }
		public PacketEntitySoundEffect(VarInt @soundId, VarInt @soundCategory, VarInt @entityId, float @volume, float @pitch, long @seed)
		{
		...
		public static PacketEntitySoundEffect Read(PacketBuffer buffer )
		{
			...
			float @pitch = ((Func<PacketBuffer, float>)((buffer) => buffer.ReadF32()))(buffer);
			long @seed = ((Func<PacketBuffer, long>)((buffer) => buffer.ReadI64()))(buffer);
			return new PacketEntitySoundEffect(@soundId, @soundCategory, @entityId, @volume, @pitch, @seed);
		}
	}
	...
	public class PacketMessageHeader : IPacketPayload
	{
		...
		public PacketMessageHeader(byte[]? @previousSignature, UUID @senderUuid, byte[] @signature, byte[] @messageHash)
		{
			this.PreviousSignature = @previousSignature;
			this.SenderUuid = @senderUuid;
			this.Signature = @signature;
		...
		public void Write(PacketBuffer buffer )
		{
			...
			((Action<PacketBuffer, UUID>)((buffer, value) => buffer.WriteUUID(value)))(buffer, this.SenderUuid);
			((Action<PacketBuffer, byte[]>)((buffer, value) => buffer.WriteBuffer(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.Signature);
			((Action<PacketBuffer, byte[]>)((buffer, value) => buffer.WriteBuffer(value, ((Action<PacketBuffer, VarInt>)((buffer, value) => buffer.WriteVarInt(value))))))(buffer, this.MessageHash);
		}
		public static PacketMessageHeader Read(PacketBuffer buffer )
		{
			...
			UUID @senderUuid = ((Func<PacketBuffer, UUID>)((buffer) => buffer.ReadUUID()))(buffer);
			byte[] @signature = ((Func<PacketBuffer, byte[]>)((buffer) => buffer.ReadBuffer(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer))))(buffer);
			byte[] @messageHash = ((Func<PacketBuffer, byte[]>)((buffer) => buffer.ReadBuffer(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer))))(buffer);
			return new PacketMessageHeader(@previousSignature, @senderUuid, @signature, @messageHash);
		}
	}
	public class Packet : IPacket
	{
		public class ParamsSwitch
		{
			...
			public static ParamsSwitch Read(PacketBuffer buffer, string state)
			{
				object? value = state switch
				{
					...
					"chat_preview" => ((Func<PacketBuffer, PacketChatPreview>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketChatPreview.Read(buffer )))(buffer),
					...
					"chat_suggestions" => ((Func<PacketBuffer, PacketChatSuggestions>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketChatSuggestions.Read(buffer )))(buffer),
					...
					"hide_message" => ((Func<PacketBuffer, PacketHideMessage>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketHideMessage.Read(buffer )))(buffer),
					...
					"message_header" => ((Func<PacketBuffer, PacketMessageHeader>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketMessageHeader.Read(buffer )))(buffer),
					"player_chat" => ((Func<PacketBuffer, PacketPlayerChat>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketPlayerChat.Read(buffer )))(buffer),
					...
					"server_data" => ((Func<PacketBuffer, PacketServerData>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketServerData.Read(buffer )))(buffer),
					...
					"should_display_chat_preview" => ((Func<PacketBuffer, PacketShouldDisplayChatPreview>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketShouldDisplayChatPreview.Read(buffer )))(buffer),
					...
					"system_chat" => ((Func<PacketBuffer, PacketSystemChat>)((buffer) => MineSharp.Data.Protocol.Play.Clientbound.PacketSystemChat.Read(buffer )))(buffer),
	...
	public class PlayPacketFactory : IPacketFactory 
	{
	    ...
	    public static void WritePacket(PacketBuffer buffer, IPacketPayload packet) 
	    {
	        switch (packet)
	        {
	                ...
	                case PacketNamedEntitySpawn p_0x02: new MineSharp.Data.Protocol.Play.Clientbound.Packet("named_entity_spawn", p_0x02!).Write(buffer); break;
	                case PacketAnimation p_0x03: new MineSharp.Data.Protocol.Play.Clientbound.Packet("animation", p_0x03!).Write(buffer); break;
	                case PacketStatistics p_0x04: new MineSharp.Data.Protocol.Play.Clientbound.Packet("statistics", p_0x04!).Write(buffer); break;
	                case PacketAcknowledgePlayerDigging p_0x05: new MineSharp.Data.Protocol.Play.Clientbound.Packet("acknowledge_player_digging", p_0x05!).Write(buffer); break;
	                case PacketBlockBreakAnimation p_0x06: new MineSharp.Data.Protocol.Play.Clientbound.Packet("block_break_animation", p_0x06!).Write(buffer); break;
	                case PacketTileEntityData p_0x07: new MineSharp.Data.Protocol.Play.Clientbound.Packet("tile_entity_data", p_0x07!).Write(buffer); break;
	                case PacketBlockAction p_0x08: new MineSharp.Data.Protocol.Play.Clientbound.Packet("block_action", p_0x08!).Write(buffer); break;
	                case PacketBlockChange p_0x09: new MineSharp.Data.Protocol.Play.Clientbound.Packet("block_change", p_0x09!).Write(buffer); break;
	                case PacketBossBar p_0x0A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("boss_bar", p_0x0A!).Write(buffer); break;
	                case PacketDifficulty p_0x0B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("difficulty", p_0x0B!).Write(buffer); break;
	                case PacketChatPreview p_0x0C: new MineSharp.Data.Protocol.Play.Clientbound.Packet("chat_preview", p_0x0C!).Write(buffer); break;
	                case PacketClearTitles p_0x0D: new MineSharp.Data.Protocol.Play.Clientbound.Packet("clear_titles", p_0x0D!).Write(buffer); break;
	                ...
	                case PacketCloseWindow p_0x10: new MineSharp.Data.Protocol.Play.Clientbound.Packet("close_window", p_0x10!).Write(buffer); break;
	                case PacketWindowItems p_0x11: new MineSharp.Data.Protocol.Play.Clientbound.Packet("window_items", p_0x11!).Write(buffer); break;
	                case PacketCraftProgressBar p_0x12: new MineSharp.Data.Protocol.Play.Clientbound.Packet("craft_progress_bar", p_0x12!).Write(buffer); break;
	                case PacketSetSlot p_0x13: new MineSharp.Data.Protocol.Play.Clientbound.Packet("set_slot", p_0x13!).Write(buffer); break;
	                case PacketSetCooldown p_0x14: new MineSharp.Data.Protocol.Play.Clientbound.Packet("set_cooldown", p_0x14!).Write(buffer); break;
	                case PacketChatSuggestions p_0x15: new MineSharp.Data.Protocol.Play.Clientbound.Packet("chat_suggestions", p_0x15!).Write(buffer); break;
	                case PacketCustomPayload p_0x16: new MineSharp.Data.Protocol.Play.Clientbound.Packet("custom_payload", p_0x16!).Write(buffer); break;
	                case PacketNamedSoundEffect p_0x17: new MineSharp.Data.Protocol.Play.Clientbound.Packet("named_sound_effect", p_0x17!).Write(buffer); break;
	                case PacketHideMessage p_0x18: new MineSharp.Data.Protocol.Play.Clientbound.Packet("hide_message", p_0x18!).Write(buffer); break;
	                case PacketKickDisconnect p_0x19: new MineSharp.Data.Protocol.Play.Clientbound.Packet("kick_disconnect", p_0x19!).Write(buffer); break;
	                case PacketEntityStatus p_0x1A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_status", p_0x1A!).Write(buffer); break;
	                case PacketExplosion p_0x1B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("explosion", p_0x1B!).Write(buffer); break;
	                case PacketUnloadChunk p_0x1C: new MineSharp.Data.Protocol.Play.Clientbound.Packet("unload_chunk", p_0x1C!).Write(buffer); break;
	                case PacketGameStateChange p_0x1D: new MineSharp.Data.Protocol.Play.Clientbound.Packet("game_state_change", p_0x1D!).Write(buffer); break;
	                case PacketOpenHorseWindow p_0x1E: new MineSharp.Data.Protocol.Play.Clientbound.Packet("open_horse_window", p_0x1E!).Write(buffer); break;
	                case PacketInitializeWorldBorder p_0x1F: new MineSharp.Data.Protocol.Play.Clientbound.Packet("initialize_world_border", p_0x1F!).Write(buffer); break;
	                case PacketKeepAlive p_0x20: new MineSharp.Data.Protocol.Play.Clientbound.Packet("keep_alive", p_0x20!).Write(buffer); break;
	                case PacketMapChunk p_0x21: new MineSharp.Data.Protocol.Play.Clientbound.Packet("map_chunk", p_0x21!).Write(buffer); break;
	                case PacketWorldEvent p_0x22: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_event", p_0x22!).Write(buffer); break;
	                case PacketWorldParticles p_0x23: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_particles", p_0x23!).Write(buffer); break;
	                case PacketUpdateLight p_0x24: new MineSharp.Data.Protocol.Play.Clientbound.Packet("update_light", p_0x24!).Write(buffer); break;
	                case PacketLogin p_0x25: new MineSharp.Data.Protocol.Play.Clientbound.Packet("login", p_0x25!).Write(buffer); break;
	                case PacketMap p_0x26: new MineSharp.Data.Protocol.Play.Clientbound.Packet("map", p_0x26!).Write(buffer); break;
	                case PacketTradeList p_0x27: new MineSharp.Data.Protocol.Play.Clientbound.Packet("trade_list", p_0x27!).Write(buffer); break;
	                case PacketRelEntityMove p_0x28: new MineSharp.Data.Protocol.Play.Clientbound.Packet("rel_entity_move", p_0x28!).Write(buffer); break;
	                case PacketEntityMoveLook p_0x29: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_move_look", p_0x29!).Write(buffer); break;
	                case PacketEntityLook p_0x2A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_look", p_0x2A!).Write(buffer); break;
	                case PacketVehicleMove p_0x2B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("vehicle_move", p_0x2B!).Write(buffer); break;
	                case PacketOpenBook p_0x2C: new MineSharp.Data.Protocol.Play.Clientbound.Packet("open_book", p_0x2C!).Write(buffer); break;
	                case PacketOpenWindow p_0x2D: new MineSharp.Data.Protocol.Play.Clientbound.Packet("open_window", p_0x2D!).Write(buffer); break;
	                case PacketOpenSignEntity p_0x2E: new MineSharp.Data.Protocol.Play.Clientbound.Packet("open_sign_entity", p_0x2E!).Write(buffer); break;
	                case PacketPing p_0x2F: new MineSharp.Data.Protocol.Play.Clientbound.Packet("ping", p_0x2F!).Write(buffer); break;
	                ...
	                case PacketMessageHeader p_0x32: new MineSharp.Data.Protocol.Play.Clientbound.Packet("message_header", p_0x32!).Write(buffer); break;
	                case PacketPlayerChat p_0x33: new MineSharp.Data.Protocol.Play.Clientbound.Packet("player_chat", p_0x33!).Write(buffer); break;
	                case PacketEndCombatEvent p_0x34: new MineSharp.Data.Protocol.Play.Clientbound.Packet("end_combat_event", p_0x34!).Write(buffer); break;
	                case PacketEnterCombatEvent p_0x35: new MineSharp.Data.Protocol.Play.Clientbound.Packet("enter_combat_event", p_0x35!).Write(buffer); break;
	                case PacketDeathCombatEvent p_0x36: new MineSharp.Data.Protocol.Play.Clientbound.Packet("death_combat_event", p_0x36!).Write(buffer); break;
	                case PacketPlayerInfo p_0x37: new MineSharp.Data.Protocol.Play.Clientbound.Packet("player_info", p_0x37!).Write(buffer); break;
	                case PacketFacePlayer p_0x38: new MineSharp.Data.Protocol.Play.Clientbound.Packet("face_player", p_0x38!).Write(buffer); break;
	                case PacketPosition p_0x39: new MineSharp.Data.Protocol.Play.Clientbound.Packet("position", p_0x39!).Write(buffer); break;
	                case PacketUnlockRecipes p_0x3A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("unlock_recipes", p_0x3A!).Write(buffer); break;
	                case PacketEntityDestroy p_0x3B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_destroy", p_0x3B!).Write(buffer); break;
	                case PacketRemoveEntityEffect p_0x3C: new MineSharp.Data.Protocol.Play.Clientbound.Packet("remove_entity_effect", p_0x3C!).Write(buffer); break;
	                case PacketResourcePackSend p_0x3D: new MineSharp.Data.Protocol.Play.Clientbound.Packet("resource_pack_send", p_0x3D!).Write(buffer); break;
	                case PacketRespawn p_0x3E: new MineSharp.Data.Protocol.Play.Clientbound.Packet("respawn", p_0x3E!).Write(buffer); break;
	                case PacketEntityHeadRotation p_0x3F: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_head_rotation", p_0x3F!).Write(buffer); break;
	                case PacketMultiBlockChange p_0x40: new MineSharp.Data.Protocol.Play.Clientbound.Packet("multi_block_change", p_0x40!).Write(buffer); break;
	                case PacketSelectAdvancementTab p_0x41: new MineSharp.Data.Protocol.Play.Clientbound.Packet("select_advancement_tab", p_0x41!).Write(buffer); break;
	                case PacketServerData p_0x42: new MineSharp.Data.Protocol.Play.Clientbound.Packet("server_data", p_0x42!).Write(buffer); break;
	                case PacketActionBar p_0x43: new MineSharp.Data.Protocol.Play.Clientbound.Packet("action_bar", p_0x43!).Write(buffer); break;
	                case PacketWorldBorderCenter p_0x44: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_border_center", p_0x44!).Write(buffer); break;
	                case PacketWorldBorderLerpSize p_0x45: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_border_lerp_size", p_0x45!).Write(buffer); break;
	                case PacketWorldBorderSize p_0x46: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_border_size", p_0x46!).Write(buffer); break;
	                case PacketWorldBorderWarningDelay p_0x47: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_border_warning_delay", p_0x47!).Write(buffer); break;
	                case PacketWorldBorderWarningReach p_0x48: new MineSharp.Data.Protocol.Play.Clientbound.Packet("world_border_warning_reach", p_0x48!).Write(buffer); break;
	                case PacketCamera p_0x49: new MineSharp.Data.Protocol.Play.Clientbound.Packet("camera", p_0x49!).Write(buffer); break;
	                case PacketHeldItemSlot p_0x4A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("held_item_slot", p_0x4A!).Write(buffer); break;
	                case PacketUpdateViewPosition p_0x4B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("update_view_position", p_0x4B!).Write(buffer); break;
	                case PacketUpdateViewDistance p_0x4C: new MineSharp.Data.Protocol.Play.Clientbound.Packet("update_view_distance", p_0x4C!).Write(buffer); break;
	                ...
	                case PacketShouldDisplayChatPreview p_0x4E: new MineSharp.Data.Protocol.Play.Clientbound.Packet("should_display_chat_preview", p_0x4E!).Write(buffer); break;
	                case PacketScoreboardDisplayObjective p_0x4F: new MineSharp.Data.Protocol.Play.Clientbound.Packet("scoreboard_display_objective", p_0x4F!).Write(buffer); break;
	                case PacketEntityMetadata p_0x50: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_metadata", p_0x50!).Write(buffer); break;
	                case PacketAttachEntity p_0x51: new MineSharp.Data.Protocol.Play.Clientbound.Packet("attach_entity", p_0x51!).Write(buffer); break;
	                case PacketEntityVelocity p_0x52: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_velocity", p_0x52!).Write(buffer); break;
	                case PacketEntityEquipment p_0x53: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_equipment", p_0x53!).Write(buffer); break;
	                case PacketExperience p_0x54: new MineSharp.Data.Protocol.Play.Clientbound.Packet("experience", p_0x54!).Write(buffer); break;
	                case PacketUpdateHealth p_0x55: new MineSharp.Data.Protocol.Play.Clientbound.Packet("update_health", p_0x55!).Write(buffer); break;
	                case PacketScoreboardObjective p_0x56: new MineSharp.Data.Protocol.Play.Clientbound.Packet("scoreboard_objective", p_0x56!).Write(buffer); break;
	                case PacketSetPassengers p_0x57: new MineSharp.Data.Protocol.Play.Clientbound.Packet("set_passengers", p_0x57!).Write(buffer); break;
	                case PacketTeams p_0x58: new MineSharp.Data.Protocol.Play.Clientbound.Packet("teams", p_0x58!).Write(buffer); break;
	                case PacketScoreboardScore p_0x59: new MineSharp.Data.Protocol.Play.Clientbound.Packet("scoreboard_score", p_0x59!).Write(buffer); break;
	                case PacketSimulationDistance p_0x5A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("simulation_distance", p_0x5A!).Write(buffer); break;
	                case PacketSetTitleSubtitle p_0x5B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("set_title_subtitle", p_0x5B!).Write(buffer); break;
	                case PacketUpdateTime p_0x5C: new MineSharp.Data.Protocol.Play.Clientbound.Packet("update_time", p_0x5C!).Write(buffer); break;
	                case PacketSetTitleText p_0x5D: new MineSharp.Data.Protocol.Play.Clientbound.Packet("set_title_text", p_0x5D!).Write(buffer); break;
	                case PacketSetTitleTime p_0x5E: new MineSharp.Data.Protocol.Play.Clientbound.Packet("set_title_time", p_0x5E!).Write(buffer); break;
	                case PacketEntitySoundEffect p_0x5F: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_sound_effect", p_0x5F!).Write(buffer); break;
	                case PacketSoundEffect p_0x60: new MineSharp.Data.Protocol.Play.Clientbound.Packet("sound_effect", p_0x60!).Write(buffer); break;
	                case PacketStopSound p_0x61: new MineSharp.Data.Protocol.Play.Clientbound.Packet("stop_sound", p_0x61!).Write(buffer); break;
	                case PacketSystemChat p_0x62: new MineSharp.Data.Protocol.Play.Clientbound.Packet("system_chat", p_0x62!).Write(buffer); break;
	                case PacketPlayerlistHeader p_0x63: new MineSharp.Data.Protocol.Play.Clientbound.Packet("playerlist_header", p_0x63!).Write(buffer); break;
	                case PacketNbtQueryResponse p_0x64: new MineSharp.Data.Protocol.Play.Clientbound.Packet("nbt_query_response", p_0x64!).Write(buffer); break;
	                case PacketCollect p_0x65: new MineSharp.Data.Protocol.Play.Clientbound.Packet("collect", p_0x65!).Write(buffer); break;
	                case PacketEntityTeleport p_0x66: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_teleport", p_0x66!).Write(buffer); break;
	                case PacketAdvancements p_0x67: new MineSharp.Data.Protocol.Play.Clientbound.Packet("advancements", p_0x67!).Write(buffer); break;
	                case PacketEntityUpdateAttributes p_0x68: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_update_attributes", p_0x68!).Write(buffer); break;
	                case PacketEntityEffect p_0x69: new MineSharp.Data.Protocol.Play.Clientbound.Packet("entity_effect", p_0x69!).Write(buffer); break;
	                case PacketDeclareRecipes p_0x6A: new MineSharp.Data.Protocol.Play.Clientbound.Packet("declare_recipes", p_0x6A!).Write(buffer); break;
	                case PacketTags p_0x6B: new MineSharp.Data.Protocol.Play.Clientbound.Packet("tags", p_0x6B!).Write(buffer); break;
	            default: throw new Exception($"Play cannot write packet of type {packet.GetType().FullName}");
	        }
	    }
	}
...
namespace MineSharp.Data.Protocol.Login.Serverbound
{
	public class PacketLoginStart : IPacketPayload
	{
		...
		public static PacketLoginStart Read(PacketBuffer buffer )
		{
			...
			SignatureContainer? @signature = ((Func<PacketBuffer, SignatureContainer?>)((buffer) => buffer.ReadOption(((Func<PacketBuffer, SignatureContainer>)((buffer) => MineSharp.Data.Protocol.Login.Serverbound.PacketLoginStart.SignatureContainer.Read(buffer ))))))(buffer);
	...
	public class PacketEncryptionBegin : IPacketPayload
	{
		public class CryptoSwitch
		{
			...
			public static CryptoSwitch Read(PacketBuffer buffer, bool state)
			{
				object? value = state switch
				{
					true => ((Func<PacketBuffer, CryptoSwitchStatetrueContainer>)((buffer) => MineSharp.Data.Protocol.Login.Serverbound.PacketEncryptionBegin.CryptoSwitch.CryptoSwitchStatetrueContainer.Read(buffer )))(buffer),
					false => ((Func<PacketBuffer, CryptoSwitchStatefalseContainer>)((buffer) => MineSharp.Data.Protocol.Login.Serverbound.PacketEncryptionBegin.CryptoSwitch.CryptoSwitchStatefalseContainer.Read(buffer )))(buffer),
				};
				return new CryptoSwitch(value);
			}
...
namespace MineSharp.Data.Protocol.Login.Clientbound
{
	...
	public class PacketSuccess : IPacketPayload
	{
		...
		public static PacketSuccess Read(PacketBuffer buffer )
		{
			UUID @uuid = ((Func<PacketBuffer, UUID>)((buffer) => buffer.ReadUUID()))(buffer);
			string @username = ((Func<PacketBuffer, string>)((buffer) => buffer.ReadPString(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt())))))(buffer);
			PropertiesElementContainer[] @properties = ((Func<PacketBuffer, PropertiesElementContainer[]>)((buffer) => buffer.ReadArray(((Func<PacketBuffer, VarInt>)((buffer) => buffer.ReadVarInt()))(buffer), ((Func<PacketBuffer, PropertiesElementContainer>)((buffer) => MineSharp.Data.Protocol.Login.Clientbound.PacketSuccess.PropertiesElementContainer.Read(buffer ))))))(buffer);
